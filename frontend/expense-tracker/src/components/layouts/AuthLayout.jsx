  ...
  return (
    <div className='flex'>
      ...
      <div className='hidden md:block w-[40vw] h-screen bg-violet-50 bg-auth-bg-img bg-cover bg-no-repeat bg-center overflow-hidden p-8 relative'>
        ...
        <img
          src={CARD_2}
          className="w-64 lg:w-[90%] absolute bottom-10 shadow-lg" alt="" />
      </div>
    </div>
  )
}
...
const StatInfoCard = ({ icon, label, value, color }) => {
  return <div className='flex gap-6 bg-white p-4 rounded-xl shadow-md shadow-purple-400/10 border border-gray-200/2'>
    <div
